...
class ParticipantesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create participante" do
    assert_difference('Participante.count') do
      post participantes_url, params: { participante: { cpf: @participante.cpf, email: @participante.email, nascimento: @participante.nascimento, nome: @participante.nome, rg: @participante.rg, tipo_pagamento: @participante.tipo_pagamento, valor_pago: @participante.valor_pago } }
    end
  ...
  test "should update participante" do
    patch participante_url(@participante), params: { participante: { cpf: @participante.cpf, email: @participante.email, nascimento: @participante.nascimento, nome: @participante.nome, rg: @participante.rg, tipo_pagamento: @participante.tipo_pagamento, valor_pago: @participante.valor_pago } }
